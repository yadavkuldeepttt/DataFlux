<script>
  ...
  <div class="main-container">
    <div class="center-div px-2 py-4" transition:fade>
      ...
      <section class="pt-5 mt-5 bg-light-primary">
        <div class="container">
          <div class="row justify-content-center text-center mb-4">
            <div class="col-xl-6 col-lg-8 col-sm-10">
              <h2 class="font-weight-bold">
                The Perfect Blend of Features <br />for your Company
              </h2>
      ...
      <div class="container mt-5 mb-5 pb-5 pt-5">
        <div class="text-center mb-2-8 mb-lg-6">
          <h2 class="display-18 display-md-16 display-lg-14 font-weight-700">
            Why choose <strong class="text-primary font-weight-700">Us</strong>
          </h2>
        ...
        <div class="row align-items-center">
          <div class="col-sm-6 col-lg-4 mb-2-9 mb-sm-0">
            <div class="pr-md-3">
              <div class="text-center text-sm-right mb-2-9">
                ...
                <h4 class="sub-info">Website Hosting</h4>
              ...
              <div class="text-center text-sm-right">
                <div class="mb-4">
                  <img
                    src="https://www.bootdey.com/image/80x80/87CEFA/000000"
                    alt="..."
                    class="rounded-circle"
                  />
                </div>
                <h4 class="sub-info">Web Designing</h4>
                <p class="display-30 mb-0">
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <div class="why-choose-center-image">
              <img
                src="https://www.bootdey.com/image/350x350/FF7F50/000000"
                alt="..."
                class="rounded-circle"
              />
            </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="pl-md-3">
              <div class="text-center text-sm-left mb-2-9">
                <div class="mb-4">
                  <img
                    src="https://www.bootdey.com/image/80x80/8A2BE2/000000"
                    alt="..."
                    class="rounded-circle"
                  />
                </div>
                <h4 class="sub-info">Web Services</h4>
                <p class="display-30 mb-0">
              ...
              <div class="text-center text-sm-left">
                <div class="mb-4">
                  <img
                    src="https://www.bootdey.com/image/80x80/20B2AA/000000"
                    alt="..."
                    class="rounded-circle"
                  />
                </div>
                <h4 class="sub-info">Backened Services</h4>
                <p class="display-30 mb-0">
