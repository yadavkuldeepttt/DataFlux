<script>
    ...
    // mock api call for getting the data
    onMount(async () => {
      try {
        info = await doCall.apiCall({
          path: "/info",
          method: "GET",
          responseTypeNeeded: "json",
        });
        item = await doCall.apiCall({
          path: "/item",
          method: "GET",
          responseTypeNeeded: "json",
        });
  
        tasks = await doCall.apiCall({
          path: "/tasks",
          method: "GET",
          responseTypeNeeded: "json",
        });
  ...
  <section class="hacker">
    <div class="hacker-container" data-testid="hackerContent">
      ...
      <nav class="navbarStar">
        <div
          class="flex justify-between items-center px-2 pt-1 pb-0"
        >
          <div class="">
      ...
      <!-- mobile sidebar -->
       ...
       <aside class="mobileSidebar">
        <div class="text-end px-2 py-1">
          <i class="fa-solid fa-times cursor-pointer" on:click={closeSidebar} />        
        </div>
        <ul class="flex flex-col justify-center gap-3 p-3">
     
          <li class="flex flex-col gap-1 items-center hover:bg-gray-200 cursor-pointer px-1 py-1 rounded-sm"   on:click={openSideMenuList}>
            ...
            <span class="text-xs tracking-[0.05rem]">
            Menu
            </span>
        </li>
          <li class="flex flex-col gap-1 items-center hover:bg-gray-200 cursor-pointer px-1 py-1 rounded-sm"  on:click={showProblemBox}>
          ...
          <li   on:click={showCalendar} class="flex flex-col gap-1 items-center hover:bg-gray-200 cursor-pointer px-1 py-1 rounded-sm"> 
          ...
          <li class="flex flex-col gap-1 items-center hover:bg-gray-200 cursor-pointer px-1 py-1 rounded-sm">
            <i class="fa-solid fa-moon"></i>
            <div class="dropdown">
              <div tabindex="0" role="button" class="m-0 text-xs tracking-[0.05rem]">
                Theme
              </div>
              <ul
                tabindex="0"
          ...
          <li class="flex flex-col gap-1 items-center hover:bg-gray-200 cursor-pointer px-1 py-1 rounded-sm"  on:click={showMessageBox}>
        ...
        >
          <div class="row">
            ...
            {#if isSplitMenu}
              ...
              {:else}
                <div class=" col-2 file-list">
                  <div class="text-end mt-2 mx-3">
            ...
            {#if codeArea}
              <div class="col code-container second-col" data-testid="codeArea">
                <div
                  on:drop={(event) => handleDrop(event)}
                  on:dragover={(event) => handleDragOver(event)}
                  class="code-header bg-green-100 flex justify-between items-center"
                >
                  <div class="flex">
                    <ul
                      data-testid="tabList"
                      class="nav nav-pills flex justify-center list-style-none"
                      id="pills-tab"
                      role="tablist"
                    >
                      {#each editorData.files as files (files.name)}
                        {#each files.tabs as tab (tab.id)}
                          <li
                            ...
                            style="font-size: 10px;"
                            class="nav-item bg-green-200 hover:bg-green-400 hover:text-white
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          tab border-end border-secondary py-0 px-1"
                          >
                            <i
                              style="font-size:10px"
                            ...
                            <a
                              style="font-size:10px"
                              class="text-decoration-none p-0 ms-1 mt-1 d-inline-block activeTabIndex
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ? 'active'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  : ''}"
                              data-bs-toggle="pill"
                              href={`#${tab.id}`}
                            ...
                            <button
                              style="font-size:11px"
                              class="bg-transparents px-0 ms-1"
                    ...
                    <span
                      style="font-size:11px"
                      class="plus-box py-2 px-2 bg-green-600 text-white border-0 rounded-0"
                ...
                <div class="row code-content">
                  <div class="col code-col2 bg-slate-200">
                    <div>
                      {#each editorData.files as files (files.name)}
                        {#each files.tabs as tab (tab.id)}
                          {#if selectedFile === tab.id}
                            <div>
                              {#if (tab.content.type === "code" && taskDescription) || (tab.content.type === "svelte" && taskDescription)}
                                <div class="d-flex">
                                  <div
                                    class=" text-gray-200 col-lg-1 code-col1 border-end border-secondary px-4 pt-2 serial-no"
                                    style="opacity:0.4;"
                                  >
                                  ...
                                  <div class="w-100">
                                    <textarea class="code-area text-xs"
                                      >{tab.content.code}</textarea
                                    >
                                  </div>
                                </div>
                              {:else if (tab.content.type === "code" && !taskDescription) || (tab.content.type === "svelte" && !taskDescription)}
                                <div
                                              ...
                                              >
                                                ...
                                                <div style="font-size:13px">
                                                  ...
                                                  <span
                                                    style="font-size:11px"
                                                    class="d-inline-block"
                                                    >Periodically run collection
                                                    at a specified time on the
                                                    Postman Cloud.
                                                  </span>
                                                </div>
                                              </div>
                                            ...
                                            <div class="mt-3">
                                              ...
                                              <div class="mt-2">
                                                ...
                                                <span style="font-size:10px"
                                                  >High frequency helps catch
                                                  issues quicker but increases <a>
                                                    resource usage .</a
                                                  >
                              ...
                              {:else if showRunManuallySection && !runcollection && !endtoendtesting}
                                ...
                                >
                                  ...
                                  >
                                    <div class="table-responsive w-100">
                                      <table
                                        class="table w-100 bg-white text-dark"
                                      >
                                        <thead
                ...
                {#if showOutputBox}
                  <div class="run-box output-box p-3 bg-gray-50">
                    <div
                      class="d-flex justify-content-between border-bottom pb-4 border-secondary"
                    >
                      <div style="border-radius:15px" class="py-2 px-4">
                        Output
                      </div>
                      <button
                        on:click={closeBox}
                        style="border:0;outline:0;background:transparent;font-size:20px;color:#fff"
                      >
                    ...
                    <div class="output mt-4">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Autem minus et porro tempore temporibus quo beatae itaque
                      omnis ratione iusto. Suscipit, impedit odio tempore unde do
                    </div>
                  </div>
                {/if}
                <div
                  class="d-flex justify-content-between align-items-center run-code pb-2"
                >
                  <div
                    class="d-flex gap-4 align-items-center p-2"
                    style="opacity: 0.7;"
                  >
                    <span>Input</span>
                    <span>Output</span>
                  ...
                  <div class="pt-2">
                    <button
                      on:click={toggleTestBox}
                      class="btn btn-outline-success"
                      style="font-size: 12px;color:lightgreen;border-color:lightgreen"
                      >Run Tests</button
                    >
                    <button
                      on:click={toggleOutputBox}
                      class="btn btn-success mx-2"
                      style="font-size: 12px;font-weight:500"
                      ><i class="bi bi-caret-right" />&nbsp;Run Code</button
                    >
                  </div>
                </div>
              </div>
            ...
            {#if isThirdColContent}
              <div class="col third-col bg-gray-100">
                <div
                        ...
                        {#each editorData.reviewFiles as files (files.name)}
                          {#each files.tabs as tab (tab.id)}
                            <li
                              ...
                              style="font-size: 12px;"
                              class="nav-item
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              tab border-end border-secondary bg-green-200 hover:bg-green-400 py-1 px-2"
                            >
                              <a
        ...
        <div class="modal-box">
         ...
         <!-- sections -->
                             ...
                             >
                                ...
                                {#if sectionsDelete.code}
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <i
                                        class="fa-solid fa-trash text-gray-500 text-xs"
                                        on:click={() => deleteSection("code")}
                                      ></i>
                                    </div>
                                    <div
                                      ...
                                      <div class="flex items-center gap-2">
                                        <i
                                          class="fa-solid fa-minus text-gray-500 {sectionsVisibility.allDocs
                                            ...
                                            : 'fa-plus'}"
                                          on:click={() =>
                                            toggleSection("allDocs")}
                                        ></i>
                                        <i
                                          class="fa-solid fa-trash text-gray-500 cursor-pointer text-xs"
                                          on:click={() =>
                                            deleteSection("allDocs")}
                                        ></i>
                                      </div>
                                    </div>
                                    {#if sectionsVisibility.allDocs}
                                ...
                                <!-- schema -->
                                {#if sectionsDelete.schema}
                                  <div
                                    class="m-2 {!sectionsDelete.build && !sectionsDelete.examples ? "mb-5" : ""} border border-gray-200 bg-gray-50 {sectionsVisibility.schema
                                      ? 'h-[35vh]'
                                      : 'h-[5vh]'}  overflow-auto scrollMiddleContent rounded tracking-[0.05rem]"
                                  >
                                    <!-- collapse buttons -->
                                ...
                                <!-- examples -->
                                {#if sectionsDelete.examples}
                                  <div
                                    class="m-2 {!sectionsDelete.build ? "mb-5" : ""} border border-gray-200 bg-gray-50 {sectionsVisibility.examples
                                      ? 'h-[35vh]'
                                      : 'h-[5vh]'}  overflow-auto scrollMiddleContent rounded tracking-[0.05rem]"
                                  >
                                    <!-- collapse buttons -->
                                ...
                                <dialog id="my_modal_43" class="modal">
                                  <div class="modal-box">
                                    <div class="mb-4">
                                      <!-- input -->
                                      <div class="mb-2">
                                    ...
                                    <!-- build section -->
                                    {#if sectionsDelete.build}
                                    <div
                                      class="m-2 mb-5 border border-gray-200 bg-gray-50 {sectionsVisibility.build
                                        ? 'h-[35vh]'
                                        : 'h-[5vh]'}  overflow-auto scrollMiddleContent rounded tracking-[0.05rem]"
                                    >
                                      <!-- collapse buttons -->
                                      <div
                                        class="flex items-center {sectionsVisibility.build
                                          ? 'justify-end'
                                          : 'justify-between'} bg-slate-100 py-1.5 px-2"
                                      >
                                        {#if !sectionsVisibility.build}
                                          <span
                                            class="text-gray-500"
                                            style="font-weight:600">Build</span
                                          >
                                        {/if}
                                        <div class="flex items-center gap-2">
                                          <i
                                            class="fa-solid fa-minus text-gray-500 {sectionsVisibility.build
                                              ? 'fa-minus'
                                              : 'fa-plus'}"
                                            on:click={() =>
                                              toggleSection("build")}
                                    ...
                                    <div class="py-2">
                                      <div class="flex gap-3 items-center mx-2">
                                        <a href="" class="text-blue-600">npm run build</a>
                                        <a href="" class="text-blue-600">Run Script</a>
                                        <a href="" class="text-blue-600">Add New examples</a>
